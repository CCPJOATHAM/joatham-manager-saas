...
class DashboardAccessTests(TestCase):
    ...
    def test_owner_navigation_contains_admin_links(self):
        ...
        self.assertContains(response, "Entreprise Dashboard")
        self.assertContains(response, "Tableau de bord exécutif")
        self.assertContains(response, "Résumé financier")
        self.assertContains(response, "Portefeuille clients")
        self.assertContains(response, "Activité récente")
        self.assertContains(response, "Alertes stock")
        self.assertContains(response, "Factures impayées")
        ...
        self.assertContains(response, reverse("proforma_list"))
        self.assertContains(response, "Proformas")
    ...
    def test_navigation_hides_modules_explicitly_missing_from_plan(self):
        ...
        self.assertNotIn("Proformas", labels)
