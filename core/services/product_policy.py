...
MODULE_ACCESS_POLICY = {
    ...
    "billing_pos": ACCESS_INCLUDED_PLAN,
    "proformas": ACCESS_INCLUDED_PLAN,
    "proforma_conversion": ACCESS_INCLUDED_PLAN,
...
MODULE_LABELS = {
    ...
    "billing": "facturation",
    "billing_pos": "impression POS",
    "proformas": "proformas",
    "proforma_conversion": "conversion proforma",
    "payments": "paiements",
...
PLAN_MODULE_ALIASES = {
    ...
    "billing_pos": {"billing_pos", "pos_simple", "pos"},
    "proformas": {"proformas", "proforma"},
    "proforma_conversion": {"proforma_conversion", "conversion_proforma"},
