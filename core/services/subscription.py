...
DEFAULT_PAID_PLANS = [
    {
        ...
        "devise": "USD",
        "duree_jours": 30,
        "description": "Facturation, clients, produits, depenses, paiements simples et caisse simple pour une petite activite.",
    ...
    },
    {
        ...
        "devise": "USD",
        "duree_jours": 30,
        "description": "Gestion complete avec caisse avancee, paiements controles, stock, inventaire, rapports et exports.",
...
PLAN_FEATURE_SUMMARY = {
    FREE_PLAN_CODE: [
        ...
        "Paiements simples et Mobile Money manuel",
    ...
    STARTER_PLAN_CODE: [
        ...
        "Paiements simples cash, Mobile Money et banque",
    ...
    PRO_PLAN_CODE: [
        ...
        "Rapports paiements et validations",
